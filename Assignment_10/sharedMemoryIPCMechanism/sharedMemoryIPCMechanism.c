...
int getValidInteger();
int readInputArray(int *);
void displayArray(int *, int);
void sortArray(int *, int);
SharedData *createAndAttachSharedMemory(int *);
void writeToSharedMemory(SharedData *, int *, int);
void waitForDataReady(SharedData *, int);
void childProcess(SharedData *);
void cleanupSharedMemory(SharedData *, int);
