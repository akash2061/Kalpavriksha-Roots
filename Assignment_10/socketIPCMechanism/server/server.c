...
float readBalance();
void writeBalance(float);
void handleWithdraw(int, float);
void handleDeposit(int, float);
void handleBalance(int);
int processClientRequest(int, int, char *);
void *handleClient(void *);
int createServerSocket();
int bindServerSocket(int);
int startListening(int);
void acceptClientConnections(int);
void initiateServer();
