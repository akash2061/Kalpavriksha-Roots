...
void prepareWithdrawRequest(char *);
void prepareDepositRequest(char *);
void prepareBalanceRequest(char *);
void prepareExitRequest(char *);
int prepareRequest(int, char *);
void sendRequest(int, char *);
void receiveAndDisplayResponse(int);
int createClientSocket();
int connectToServer(int);
void handleTransactions(int);
void initiateClient();
